...
const WeatherCard = ({ location }) => {
  const imgSrc =
    location?.main?.temp < 30
      ...
      : "https://media.istockphoto.com/id/813720840/photo/summer-heat-wave-in-the-city.jpg?s=2048x2048&w=is&k=20&c=GFLYF-pRw41qTUwGyU4V1J1qcI0ilFkKx0zuDPd_uqE=";
  return (
      ...
      <Card sx={{ width: 360 }}>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            <div>
              The temperatures of {location?.name} feels like{" "}
